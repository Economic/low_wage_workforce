...
Plot.plot({
  ...
  style: "padding-top:1em; overflow:visible; font-size: 16px;",
  y: {
    grid: true,
    domain: [0, max_value_12m*1.10],
    label: outcome == "share" ? "Percent of workforce earning less than $" + threshold : "Millions of workers earning less than $" + threshold,
